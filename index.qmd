...
- <i class="fa-solid fa-building-columns"></i> [FMI group page](https://www.fmi.ch/platforms/platform.html?plt=115){target="_blank"}
- <i class="fa-solid fa-people-group"></i> [SIB group page](https://www.sib.swiss/michael-stadler-group){target="_blank"}
- <i class="fa-brands fa-github"></i> [Tools and data](https://fmicompbio.github.io){target="_blank"}
- <i class="fa-brands fa-google-scholar"></i> [Publications (Google scholar)](https://scholar.google.com/citations?user=UAcx9iMAAAAJ&hl=en){target="_blank"}
